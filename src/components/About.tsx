  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-semibold">frontend development</span>. I
        specialize in building responsive, user-friendly applications using{" "}
        <span className="font-medium">Flutter</span> for mobile and{" "}
        <span className="font-medium">React</span> for the web. <br /> <br />{" "}
        I’ve successfully deployed apps to the{" "}
        <span className="font-medium">Play Store and </span>
        <span className="font-medium">App Store</span>, blending{" "}
        <span className="italic">creativity</span> with functionality across
        platforms.
      </motion.p>
      {/* <motion.button
