  ...
  return (
    ...
    <div className="flex items-center justify-center ">
     ...
     <div className="flex justify-center gap-6 text-2xl text-gray-600 mt-5 z-10">
         ...
         <motion.div
          className="text-black  bg-white/10 backdrop-blur-[0.5px] border border-white/90 shadow-2xl w-fit flex items-center justify-center mx-auto rounded-4xl px-4 py-1 mt-5 z-10 relative"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
