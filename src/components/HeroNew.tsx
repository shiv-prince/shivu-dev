  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="h-auto bg-hero-pattern py-20 bg-cover bg-center flex flex-col items-center justify-center mtext-center z-10 "
      >
        <div className="flex items-center justify-center ">
          <motion.img
            ...
            className="w-20 h-20 mr-3 rounded-2xl shadow-lg z-10"
            src="./shivu_dev.jpg"
            alt="homeimg"
          />
          <h1 className="text-7xl md:text-7xl font-normal text-gray-900 font-display text-shadow-lg z-10 dark:text-gray-200">
            SHIVU
          </h1>
        </div>
        <p className="flex items-center justify-center text-xl text-gray-600 mt-4 z-10 dark:text-gray-50">
